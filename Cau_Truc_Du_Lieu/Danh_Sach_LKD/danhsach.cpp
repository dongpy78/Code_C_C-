#include <iostream>
using namespace std;
// Bài toán nhập danh sách liên kết đơn
// ============= KHAI BÁO DANH SÁCH LIÊN KẾT ĐƠN CÁC SỐ NGUYÊN =============

// Khai báo cấu trúc 1 cái node 
struct node {
  int data; // dữ liệu chứa trong một cái node 
  struct node *pNext; // con trỏ dùng để liên kết các cái node lại với nhau
};
...
NODE *KhoiTaoNode(int x) {
  ...
  p ->pNext = NULL; // đầu tiên khai báo node thì node đó chưa có liên kết đến node nào hết => con trỏ sẽ trỏ đến NULL
